...
%             p_value_2
        ...
        format long g
        xlswrite('p-values.xlsx',[p_value_1(1:length(p_value_1)-1);p_value_2(1:length(p_value_2)-1)],'Japan',place(i-2,:));
        ...
        annotation('textbox',...
            ...
            'String',{'Japan-Waiting Times,Entire Data Set: Observed vs. Expected'},...
            'FontWeight','bold',...
            'FontSize',14,...
            'FontName','Arial',...
            'FitBoxToText','off');
...
text(5.5,7000,'Japan,15250 Events'); 
text(5.5,6000,'2/9/1963-4/19/2013'); 
